...
> {
  ...
  renderWrappedChildren(children) {
    ...
    return React.Children.map(children, (child: React.ReactElement<any>) => {
      ...
      // Adaptation for the wrapper to integrate the dRural Checkbox in this Form
      if (child.type === CheckBoxLoginWrapper) {
      ...
      if (
        ...
        child.type === NumberFormat ||
        child.type === InputLoginFormWrapper
      ) {
