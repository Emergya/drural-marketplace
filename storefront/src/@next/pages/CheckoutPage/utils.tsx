import type { IItems } from "@drural/sdk/lib/api/Cart/types";
...
export const prepareCartSummaryProducts = (
  ...
  items?.map(({ id, bookingId, variant, totalPrice, quantity }) => ({
    id: id || "",
    bookingId: bookingId || "",
...
export const getContinueButtonText = (
  ...
  if (step === CheckoutStep.Address && !isShippingRequired) {
    return continueButtonTextMap[CheckoutStep.Shipping];
  }
  return continueButtonTextMap[step];
};
