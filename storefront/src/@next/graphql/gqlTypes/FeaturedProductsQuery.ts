...
export interface FeaturedProductsQuery_collection_products_edges_node_reviews {
...
export interface FeaturedProductsQuery_collection_products_edges_node {
   ...
   */
  reviews: FeaturedProductsQuery_collection_products_edges_node_reviews | null;
}
