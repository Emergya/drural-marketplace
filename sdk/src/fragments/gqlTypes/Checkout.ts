...
export interface Checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface Checkout_lines_variant_product_paymentMethods {
...
export interface Checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface Checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: Checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface Checkout_lines_variant_product {
   ...
   */
  paymentMethods: (Checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: Checkout_lines_variant_product_company;
}
...
export interface Checkout_lines {
   ...
   */
  id: string;
  booking: Checkout_lines_booking | null;
  quantity: number;
  /**
