...
export interface CheckoutLine_booking {
  __typename: "Booking";
  /**
...
export interface CheckoutLine_variant_product_paymentMethods {
...
export interface CheckoutLine_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface CheckoutLine_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: CheckoutLine_variant_product_company_stripeCredentials | null;
}
...
export interface CheckoutLine_variant_product {
   ...
   */
  paymentMethods: (CheckoutLine_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: CheckoutLine_variant_product_company;
}
...
export interface CheckoutLine {
   ...
   */
  id: string;
  booking: CheckoutLine_booking | null;
  quantity: number;
  /**
