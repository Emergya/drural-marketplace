...
export interface ProductVariant_product_paymentMethods {
...
export interface ProductVariant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface ProductVariant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: ProductVariant_product_company_stripeCredentials | null;
}
...
export interface ProductVariant_product {
   ...
   */
  paymentMethods: (ProductVariant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: ProductVariant_product_company;
}
