...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product_paymentMethods {
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_product_company;
}
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines {
   ...
   */
  id: string;
  booking: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_booking | null;
  quantity: number;
  /**
