...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product_paymentMethods {
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_product_company;
}
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines {
   ...
   */
  id: string;
  booking: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_booking | null;
  quantity: number;
  /**
