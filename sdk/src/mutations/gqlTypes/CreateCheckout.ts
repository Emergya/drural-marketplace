...
export interface CreateCheckout_checkoutCreate_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_paymentMethods {
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: CreateCheckout_checkoutCreate_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (CreateCheckout_checkoutCreate_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: CreateCheckout_checkoutCreate_checkout_lines_variant_product_company;
}
...
export interface CreateCheckout_checkoutCreate_checkout_lines {
   ...
   */
  id: string;
  booking: CreateCheckout_checkoutCreate_checkout_lines_booking | null;
  quantity: number;
  /**
