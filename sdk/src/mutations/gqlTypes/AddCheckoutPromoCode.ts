...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_paymentMethods {
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_company;
}
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines {
   ...
   */
  id: string;
  booking: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_booking | null;
  quantity: number;
  /**
