...
export interface CompleteCheckout_checkoutComplete_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface CompleteCheckout_checkoutComplete_order_booking {
  __typename: "Booking";
  bookableResource: CompleteCheckout_checkoutComplete_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface CompleteCheckout_checkoutComplete_order_billingAddress_country {
...
export interface CompleteCheckout_checkoutComplete_order_billingAddress {
  __typename: "Address";
  /**
   ...
   */
  country: CompleteCheckout_checkoutComplete_order_billingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_paymentMethods {
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: CompleteCheckout_checkoutComplete_order_lines_variant_product_company_stripeCredentials | null;
}
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product {
   ...
   */
  paymentMethods: (CompleteCheckout_checkoutComplete_order_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: CompleteCheckout_checkoutComplete_order_lines_variant_product_company;
}
...
export interface CompleteCheckout_checkoutComplete_order {
   ...
   */
  booking: CompleteCheckout_checkoutComplete_order_booking | null;
  billingAddress: CompleteCheckout_checkoutComplete_order_billingAddress | null;
