...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product_paymentMethods {
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_product_company;
}
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines {
   ...
   */
  id: string;
  booking: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_booking | null;
  quantity: number;
  /**
