...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_paymentMethods {
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_company;
}
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines {
   ...
   */
  id: string;
  booking: UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_booking | null;
  quantity: number;
  /**
