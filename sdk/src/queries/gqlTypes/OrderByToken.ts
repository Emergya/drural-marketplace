...
export interface OrderByToken_orderByToken_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderByToken_orderByToken_booking {
  __typename: "Booking";
  bookableResource: OrderByToken_orderByToken_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderByToken_orderByToken_billingAddress_country {
...
export interface OrderByToken_orderByToken_billingAddress {
  __typename: "Address";
  /**
   ...
   */
  country: OrderByToken_orderByToken_billingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
...
export interface OrderByToken_orderByToken_lines_variant_product_paymentMethods {
...
export interface OrderByToken_orderByToken_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface OrderByToken_orderByToken_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: OrderByToken_orderByToken_lines_variant_product_company_stripeCredentials | null;
}
...
export interface OrderByToken_orderByToken_lines_variant_product {
   ...
   */
  paymentMethods: (OrderByToken_orderByToken_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: OrderByToken_orderByToken_lines_variant_product_company;
}
...
export interface OrderByToken_orderByToken {
   ...
   */
  booking: OrderByToken_orderByToken_booking | null;
  billingAddress: OrderByToken_orderByToken_billingAddress | null;
