...
export interface CheckoutProductVariants_productVariants_edges_node_product_paymentMethods {
...
export interface CheckoutProductVariants_productVariants_edges_node_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface CheckoutProductVariants_productVariants_edges_node_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: CheckoutProductVariants_productVariants_edges_node_product_company_stripeCredentials | null;
}
...
export interface CheckoutProductVariants_productVariants_edges_node_product {
   ...
   */
  paymentMethods: (CheckoutProductVariants_productVariants_edges_node_product_paymentMethods | null)[] | null;
  /**
  ...
  company: CheckoutProductVariants_productVariants_edges_node_product_company;
}
