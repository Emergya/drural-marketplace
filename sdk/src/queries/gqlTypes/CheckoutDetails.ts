...
export interface CheckoutDetails_checkout_lines_booking {
  __typename: "Booking";
  /**
   * The ID of the object.
   */
...
export interface CheckoutDetails_checkout_lines_variant_product_paymentMethods {
...
export interface CheckoutDetails_checkout_lines_variant_product_company_stripeCredentials {
  __typename: "StripeCredentialsType";
  isEnabled: boolean;
  accountId: string | null;
}

export interface CheckoutDetails_checkout_lines_variant_product_company {
  __typename: "CompanyType";
  /**
   * The ID of the object.
   */
  id: string;
  stripeCredentials: CheckoutDetails_checkout_lines_variant_product_company_stripeCredentials | null;
}
...
export interface CheckoutDetails_checkout_lines_variant_product {
   ...
   */
  paymentMethods: (CheckoutDetails_checkout_lines_variant_product_paymentMethods | null)[] | null;
  /**
  ...
  company: CheckoutDetails_checkout_lines_variant_product_company;
}
...
export interface CheckoutDetails_checkout_lines {
   ...
   */
  id: string;
  booking: CheckoutDetails_checkout_lines_booking | null;
  quantity: number;
  /**
