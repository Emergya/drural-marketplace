...
import { CountryCode, VariantAttributeScope, ProductAddressCountry } from "./../../gqlTypes/globalTypes";
...
export interface ProductDetails_product_company_products {
...
export interface ProductDetails_product_company {
   ...
   */
  products: ProductDetails_product_company_products | null;
}
...
export interface ProductDetails_product_category_products_edges_node_address {
...
export interface ProductDetails_product_category_products_edges_node {
  ...
  address: ProductDetails_product_category_products_edges_node_address | null;
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_thumbnail {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_start_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_start_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_start {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_start_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_start_net;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_stop_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_stop_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_stop {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_stop_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_stop_net;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted {
  __typename: "TaxedMoneyRange";
  /**
   * Lower bound of a price range.
   */
  start: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_start | null;
  /**
   * Upper bound of a price range.
   */
  stop: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted_stop | null;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_start_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_start_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_start {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_start_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_start_net;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_stop_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_stop_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_stop {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_stop_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_stop_net;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange {
  __typename: "TaxedMoneyRange";
  /**
   * Lower bound of a price range.
   */
  start: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_start | null;
  /**
   * Upper bound of a price range.
   */
  stop: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange_stop | null;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node_pricing {
  __typename: "ProductPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The undiscounted price range of the product variants.
   */
  priceRangeUndiscounted: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRangeUndiscounted | null;
  /**
   * The discounted price range of the product variants.
   */
  priceRange: ProductDetails_product_categories_edges_node_products_edges_node_pricing_priceRange | null;
}

export interface ProductDetails_product_categories_edges_node_products_edges_node {
  __typename: "Product";
  /**
   * The ID of the object.
   */
   ...
   * The main thumbnail for a product.
   */
  thumbnail: ProductDetails_product_categories_edges_node_products_edges_node_thumbnail | null;
  /**
   * The main thumbnail for a product.
   */
  thumbnail2x: ProductDetails_product_categories_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: ProductDetails_product_categories_edges_node_products_edges_node_pricing | null;
}

export interface ProductDetails_product_categories_edges_node_products_edges {
  __typename: "ProductCountableEdge";
  /**
   * The item at the end of the edge.
   */
  node: ProductDetails_product_categories_edges_node_products_edges_node;
}

export interface ProductDetails_product_categories_edges_node_products {
  __typename: "ProductCountableConnection";
  edges: ProductDetails_product_categories_edges_node_products_edges[];
}
...
export interface ProductDetails_product_categories_edges_node {
   ...
   * List of products in the category.
   */
  products: ProductDetails_product_categories_edges_node_products | null;
}
