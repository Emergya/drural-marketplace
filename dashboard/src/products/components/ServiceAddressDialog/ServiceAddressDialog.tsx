...
import BusinessMapUpdate from "@saleor/business/components/BusinessMapUpdate";
...
const useStyles = makeStyles(
  ...
  { name: "ServiceAddressDialog" }
);

export interface ServiceAddressDialogProps {
  address: ProductAddressFormData;
  open: boolean;
  setShowAddressBox?: () => void;
  onClose: () => void;
  onChange(event: any);
}
export interface ServiceAddressDialogFormData {
  country: string;
  locality: string;
  postalCode: string;
  region: string;
...
const initialValuesAddress: ServiceAddressDialogFormData = {
  country: "",
  locality: "",
  postalCode: "",
  region: "",
...
const ServiceAddressDialog: React.FC<ServiceAddressDialogProps> = ({
  address,
  open,
  onClose,
  onChange,
...
ServiceAddressDialog.displayName = "ServiceAddressDialog";
export default ServiceAddressDialog;
