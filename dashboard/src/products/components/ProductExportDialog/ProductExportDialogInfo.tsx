    ...
    <>
      <Typography className={classes.dialogLabel}>
        <FormattedMessage
          ...
          description="select service informations to be exported"
        />
      </Typography>
      ...
      <FieldAccordion
        ...
        title={intl.formatMessage({
          defaultMessage: "Service Organization",
          description: "informations about service organization, header"
        })}
        data={data}
        fields={[
      ...
      <FieldAccordion
        ...
        title={intl.formatMessage({
          ...
          description: "informations about service prices etc, header"
        })}
        data={data}
      ...
      {/* <Accordion
        ...
        title={intl.formatMessage({
          ...
          description: "informations about service stock, header"
        })}
        quickPeek={
          user.isStaff &&
      ...
      >
        ...
        {user.isStaff && (
          <>
            ...
            <Typography>
              <FormattedMessage defaultMessage="Export Service Stock Quantity to CSV" />
            </Typography>
            <div>
              <Option
      ...
      <FieldAccordion
        title={intl.formatMessage({
          ...
          description: "informations about service seo, header"
        })}
        data={data}
        fields={[
