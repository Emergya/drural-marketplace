...
import {
  ProductPurchaseEmailUpdate,
  ProductPurchaseEmailUpdateVariables
} from "./types/ProductPurchaseEmailUpdate";
...
// Purchase Email
export const productPurchaseEmailUpdateMutation = gql`
  ${productErrorWithAttributesFragment}
  mutation ProductPurchaseEmailUpdate(
    $id: ID!
    $purchaseEmail: PurchaseEmailInput
  ) {
    productUpdate(id: $id, input: { purchaseEmail: $purchaseEmail }) {
      errors {
        ...ProductErrorWithAttributesFragment
      }
      product {
...
`;
export const useProductPurchaseEmailUpdateMutation = makeMutation<
  ProductPurchaseEmailUpdate,
  ProductPurchaseEmailUpdateVariables
>(productPurchaseEmailUpdateMutation);
