...
import StaffAddMemberDialog from "../../../components/AddMemberDialog";
import { AddMemberFormData } from "../../../components/AddMemberDialog/types";
  ...
  return (
    <>
      <StaffListPage
        ...
        onSort={handleSort}
        totalCount={staffQueryData?.staffUsers.totalCount}
      />
      <StaffAddMemberDialog
        ...
        title={intl.formatMessage({ defaultMessage: "Invite Staff Member" })}
        onClose={closeModal}
