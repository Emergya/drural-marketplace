...
export interface FulfillOrder_orderFulfill_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface FulfillOrder_orderFulfill_order_booking {
  __typename: "Booking";
  bookableResource: FulfillOrder_orderFulfill_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface FulfillOrder_orderFulfill_order {
   ...
   */
  booking: FulfillOrder_orderFulfill_order_booking | null;
  /**
