...
export interface OrderDiscountUpdate_orderDiscountUpdate_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderDiscountUpdate_orderDiscountUpdate_order_booking {
  __typename: "Booking";
  bookableResource: OrderDiscountUpdate_orderDiscountUpdate_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderDiscountUpdate_orderDiscountUpdate_order {
   ...
   */
  booking: OrderDiscountUpdate_orderDiscountUpdate_order_booking | null;
  /**
