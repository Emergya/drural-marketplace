...
export interface OrderLinesAdd_orderLinesCreate_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderLinesAdd_orderLinesCreate_order_booking {
  __typename: "Booking";
  bookableResource: OrderLinesAdd_orderLinesCreate_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderLinesAdd_orderLinesCreate_order {
   ...
   */
  booking: OrderLinesAdd_orderLinesCreate_order_booking | null;
  /**
