...
export interface OrderShippingMethodUpdate_orderUpdateShipping_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderShippingMethodUpdate_orderUpdateShipping_order_booking {
  __typename: "Booking";
  bookableResource: OrderShippingMethodUpdate_orderUpdateShipping_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderShippingMethodUpdate_orderUpdateShipping_order {
   ...
   */
  booking: OrderShippingMethodUpdate_orderUpdateShipping_order_booking | null;
  /**
