...
export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_booking {
  __typename: "Booking";
  bookableResource: OrderLineDiscountRemove_orderLineDiscountRemove_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderLineDiscountRemove_orderLineDiscountRemove_order {
   ...
   */
  booking: OrderLineDiscountRemove_orderLineDiscountRemove_order_booking | null;
  /**
