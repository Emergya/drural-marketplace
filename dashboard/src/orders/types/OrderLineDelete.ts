...
export interface OrderLineDelete_orderLineDelete_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderLineDelete_orderLineDelete_order_booking {
  __typename: "Booking";
  bookableResource: OrderLineDelete_orderLineDelete_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderLineDelete_orderLineDelete_order {
   ...
   */
  booking: OrderLineDelete_orderLineDelete_order_booking | null;
  /**
