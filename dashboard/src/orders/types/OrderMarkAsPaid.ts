...
export interface OrderMarkAsPaid_orderMarkAsPaid_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderMarkAsPaid_orderMarkAsPaid_order_booking {
  __typename: "Booking";
  bookableResource: OrderMarkAsPaid_orderMarkAsPaid_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderMarkAsPaid_orderMarkAsPaid_order {
   ...
   */
  booking: OrderMarkAsPaid_orderMarkAsPaid_order_booking | null;
  /**
