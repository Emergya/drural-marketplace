...
export interface OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order_booking {
  __typename: "Booking";
  bookableResource: OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order {
   ...
   */
  booking: OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order_booking | null;
  /**
