...
export interface OrderVoid_orderVoid_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderVoid_orderVoid_order_booking {
  __typename: "Booking";
  bookableResource: OrderVoid_orderVoid_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderVoid_orderVoid_order {
   ...
   */
  booking: OrderVoid_orderVoid_order_booking | null;
  /**
