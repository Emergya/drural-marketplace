...
export interface OrderUpdate_orderUpdate_order_booking_bookableResource {
  __typename: "BookableResource";
  name: string;
}

export interface OrderUpdate_orderUpdate_order_booking {
  __typename: "Booking";
  bookableResource: OrderUpdate_orderUpdate_order_booking_bookableResource | null;
  startDate: any | null;
  endDate: any | null;
  /**
   * UUID of the booking.
...
export interface OrderUpdate_orderUpdate_order {
   ...
   */
  booking: OrderUpdate_orderUpdate_order_booking | null;
  /**
