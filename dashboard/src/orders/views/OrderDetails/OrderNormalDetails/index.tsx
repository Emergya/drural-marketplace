...
} from "@saleor/orders/types/OrderFulfillmentCancel";
import { PartialMutationProviderOutput } from "@saleor/types";
import { UserSections, userUrl } from "@saleor/users/urls";
  ...
  return (
    <>
      ...
      <OrderDetailsPage
        ...
        onOrderFulfill={orderFullfill /* () => navigate(orderFulfillUrl(id)) */}
        onFulfillmentCancel={
          fulfillmentId =>
        ...
        onProfileView={() =>
          navigate(userUrl(UserSections.customers, order.user.id))
        }
        onInvoiceClick={id =>
          window.open(
