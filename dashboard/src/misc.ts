...
// Businesses
export const businessStatusMessages = defineMessages({
  accepted: {
    defaultMessage: "Accepted",
    description: "bussiness status"
  },
  rejected: {
...
export const businessActiveShopMessages = defineMessages({
  active: {
    defaultMessage: "Active",
    description: "bussiness user status"
  },
  deactive: {
...
export const getBusinessStatus = (
  ...
  localized: string;
  // this one is for status label components
  status?: StatusLabelProps["status"];
  // this one is for Status chip component
  chipStatus?: StatusType;
} => {
  switch (status) {
    case CompanyStatus.ACC:
      return {
        localized: intl.formatMessage(businessStatusMessages.accepted),
        status: "success",
        chipStatus: StatusType.SUCCESS
      };
    case CompanyStatus.REJ:
      return {
        localized: intl.formatMessage(businessStatusMessages.rejected),
        status: "neutral",
        chipStatus: StatusType.NEUTRAL
      };
    case CompanyStatus.PEN:
      return {
        localized: intl.formatMessage(businessStatusMessages.pending),
        status: "alert",
        chipStatus: StatusType.ALERT
      };
    case CompanyStatus.DEA:
      return {
        localized: intl.formatMessage(businessStatusMessages.suspended),
        status: "error",
        chipStatus: StatusType.ERROR
      };
    default:
      return {
        localized: intl.formatMessage(businessStatusMessages.noInfo),
        status: "error",
        chipStatus: StatusType.ERROR
      };
  }
...
// Products
export const productStatusMessages = defineMessages({
  activeProduct: {
    defaultMessage: "Active",
...
export const transformProductStatus = (
  ...
  if (status) {
    return {
      localized: intl.formatMessage(productStatusMessages.activeProduct),
      status: StatusType.SUCCESS
    };
  }
  return {
    localized: intl.formatMessage(productStatusMessages.deactiveProduct),
    status: StatusType.ERROR
  };
};
