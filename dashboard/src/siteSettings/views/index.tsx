...
import { CountryCode, LanguageCodeEnum } from "../../types/globalTypes";
import SiteSettingsPage from "../components/SiteSettingsPage";
import { SiteSettingsPageFormData } from "../components/SiteSettingsPage/types";
import { areAddressInputFieldsModified } from "../components/SiteSettingsPage/utils";
            ...
            const handleUpdateShopSettings = async (
              ...
              const result = await updateShopSettings({
                variables: {
                  ...
                  shopSettingsInput: {
                    commissionRate: parseFloat(data.comissionRate),
                    description: data.description,
                    defaultLanguage: data.defaultLanguage.toUpperCase() as LanguageCodeEnum,
                    gaTag: {
                      isActive: data.ga4Active,
                      measurementId: data.ga4
                    }
                  }
                }
              });
