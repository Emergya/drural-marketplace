...
export interface CustomerDetails_user_addresses_country {
...
export interface CustomerDetails_user_addresses {
  __typename: "Address";
  city: string;
  cityArea: string;
  companyName: string;
   ...
   */
  country: CustomerDetails_user_addresses_country;
  countryArea: string;
  firstName: string;
  /**
...
export interface CustomerDetails_user {
   ...
   */
  addresses: (CustomerDetails_user_addresses | null)[] | null;
