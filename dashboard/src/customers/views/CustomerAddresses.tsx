...
import { userListUrl, UserSections, userUrl } from "@saleor/users/urls";
...
const CustomerAddresses: React.FC<CustomerAddressesProps> = ({
  ...
  const handleBack = () => navigate(userListUrl(UserSections.customers));
                  ...
                  {(removeCustomerAddress, removeCustomerAddressOpts) => (
                    <TypedCustomerAddressesQuery variables={{ id }}>
                      {customerData => {
                        ...
                        const user = customerData?.data?.user;
                        ...
                        return (
                          <>
                            ...
                            <CustomerAddressListPage
                              ...
                              onAdd={() => openModal("add")}
                              onBack={() =>
                                navigate(userUrl(UserSections.customers, id))
                              }
                              onEdit={id =>
                                openModal("edit", {
                                  id
