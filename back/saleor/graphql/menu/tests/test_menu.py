...
def test_menu_item_query(user_api_client, menu_item, published_collection, channel_EUR):
...
def test_menu_item_query_with_invalid_channel(
    user_api_client, menu_item, published_collection, channel_EUR
):
    query = QUERY_MENU_ITEM_BY_ID
    menu_item.collection = published_collection
    menu_item.url = None
...
def test_menu_items_query(
    user_api_client, menu_with_items, published_collection, channel_EUR, category
):
    query = """
