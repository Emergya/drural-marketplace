...
from ...company import error_codes as company_error_codes
...
CompanyErrorCode = graphene.Enum.from_enum(company_error_codes.CompanyErrorCode)
...
ReportErrorCode = graphene.Enum.from_enum(product_error_codes.ReportErrorCode)
BookableResourceErrorCode = graphene.Enum.from_enum(
    product_error_codes.BookableResourceErrorCode
)
BookingErrorCode = graphene.Enum.from_enum(product_error_codes.BookingErrorCode)
