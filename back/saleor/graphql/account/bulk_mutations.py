...
from ...account.utils import requestor_is_staff_and_has_permissions
...
class CustomerBulkDelete(CustomerDeleteMixin, UserBulkDelete):
    ...
    def check_permissions(cls, context):
        ...
        return requestor_is_staff_and_has_permissions(
            requestor, [AccountPermissions.MANAGE_USERS]
        )
