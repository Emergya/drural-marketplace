...
def test_product_details(product_with_image, api_client, count_queries, channel_EUR):
    query = """
...
def test_retrieve_product_attributes(
    product_list, api_client, count_queries, channel_EUR
):
    query = """
...
@pytest.mark.django_db
@pytest.mark.count_queries(autouse=False)
def test_retrieve_product_images(product_list, api_client, count_queries, channel_EUR):
    query = """
        query($sortBy: ProductOrder, $channel: String) {
          products(first: 10, sortBy: $sortBy, channel: $channel) {
            edges {
...
@pytest.mark.django_db
@pytest.mark.count_queries(autouse=False)
def test_retrieve_product_media(product_list, api_client, count_queries, channel_EUR):
    query = """
        query($sortBy: ProductOrder, $channel: String) {
          products(first: 10, sortBy: $sortBy, channel: $channel) {
            edges {
...
def test_filter_products_by_attributes(
    api_client, product_list, channel_EUR, count_queries
):
    query = """
...
def test_filter_products_by_numeric_attributes(
    api_client, product_list, numeric_attribute, channel_EUR, count_queries
):
    query = """
      query ($channel: String,  $filter: ProductFilterInput){
          products(
...
def test_filter_products_by_boolean_attributes(
    api_client, product_list, boolean_attribute, channel_EUR, count_queries
):
    query = """
      query ($channel: String,  $filter: ProductFilterInput){
          products(
...
@pytest.mark.django_db
@pytest.mark.count_queries(autouse=False)
def test_product_translations(api_client, product_list, channel_EUR, count_queries):
    query = """
      query($channel: String) {
