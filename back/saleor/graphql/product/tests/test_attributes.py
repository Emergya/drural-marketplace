...
def test_resolve_attribute_values(user_api_client, product, staff_user, channel_EUR):
...
def test_resolve_attribute_values_non_assigned_to_node(
    user_api_client, product, staff_user, channel_EUR
):
...
def test_resolve_assigned_attribute_without_values(
    api_client, product_type, product, channel_EUR
):
