...
def test_get_variant_by_id_as_customer(user_api_client, variant, channel_EUR):
    # given
    variant_id = graphene.Node.to_global_id("ProductVariant", variant.pk)
    variables = {"id": variant_id, "channel": channel_EUR.slug}
...
def test_get_variant_by_id_as_anonymous_user(api_client, variant, channel_EUR):
    # given
    variant_id = graphene.Node.to_global_id("ProductVariant", variant.pk)
    variables = {"id": variant_id, "channel": channel_EUR.slug}
...
def test_get_variant_by_sku_as_customer(user_api_client, variant, channel_EUR):
    # given
    variables = {"sku": variant.sku, "channel": channel_EUR.slug}
...
def test_get_variant_by_sku_as_anonymous_user(api_client, variant, channel_EUR):
    # given
    variables = {"sku": variant.sku, "channel": channel_EUR.slug}
