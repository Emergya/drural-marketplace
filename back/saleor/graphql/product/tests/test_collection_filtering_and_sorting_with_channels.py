...
@pytest.fixture
def collections_for_sorting_with_channels(channel_EUR):
...
def test_collections_with_sorting_and_channel_EUR(
    sort_by,
    collections_order,
    staff_api_client,
    permission_manage_products,
...
def test_collections_with_filtering_with_channel_EUR(
    filter_by,
    collections_count,
    staff_api_client,
    permission_manage_products,
