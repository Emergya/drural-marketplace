...
from .company.schema import CompanyMutations, CompanyQueries
...
from .wishlist.schema import WishlistMutations, WishlistQueries

class NoneQuery(graphene.ObjectType):
    pass

class NoneMutations(graphene.ObjectType):
    pass
...
class Query(
    ...
    PaymentQueries,
    ProductQueries,
    ShippingQueries if FEATURE_SHIPPING else NoneQuery,
    ShopQueries,
    StockQueries,
    TranslationQueries,
    WarehouseQueries,
...
class Mutation(
    ...
    PaymentMutations,
    ProductMutations,
    ShippingMutations if FEATURE_SHIPPING else NoneMutations,
    ShopMutations,
    WarehouseMutations,
    WebhookMutations,
    CompanyMutations,
