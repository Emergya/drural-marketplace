...
class OrderLine(CountableDjangoObjectType):
    ...
    def resolve_variant(root: models.OrderLine, info):
        ...
        def requestor_has_access_to_variant(data):
            ...
            has_required_permission = has_one_of_permissions_as_staff(
...
class Order(CountableDjangoObjectType):
    ...
    booking = graphene.Field(Booking, description="Booking of the order")
    ...
    @staticmethod
    @traced_resolver
    def resolve_booking(root: models.Order, info):
        return root.booking
