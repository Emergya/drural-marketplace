...
def filter_by_query_param_and_keywords(queryset, query, search_fields):
    """Filter queryset according to given parameters.
    ...
    """
    keywords = [x.lower() for x in query.split(" ") if x]
    ...
    if query:
        ...
        for keyword in keywords:
            query_objects |= Q(keywords__name_keyword=keyword)
