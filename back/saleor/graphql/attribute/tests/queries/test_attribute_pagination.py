...
@pytest.fixture
def attributes_for_pagination(collection, category, company, channel_EUR):
...
def test_attributes_pagination_with_filtering_in_collection(
    staff_api_client, attributes_for_pagination, collection, channel_EUR
):
    page_size = 2
...
def test_attributes_pagination_with_filtering_in_category(
    staff_api_client, attributes_for_pagination, category, channel_EUR
):
    page_size = 2
    attributes_order = ["Attr3", "AttrAttr2"]
