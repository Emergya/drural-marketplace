...
login_or_app_required = account_passes_test(
    lambda context: context.app or context.user.is_authenticated
)

login_required = account_passes_test(lambda context: context.user.is_authenticated)
