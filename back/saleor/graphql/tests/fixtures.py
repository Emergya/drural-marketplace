    ...
    def post_graphql(
        ...
        **kwargs,
        ...
        if permissions:
            ...
            if self.app:
                self.app.user.user_permissions.add(*permissions)
...
@pytest.fixture
def admin_app_api_client(app_admin):
    return ApiClient(app=app_admin)


@pytest.fixture
def customer_app_api_client(app_customer):
    return ApiClient(app=app_customer)


@pytest.fixture
def seller_app_api_client(app_seller):
    return ApiClient(app=app_seller)
...
@pytest.fixture
def user_api_client2(customer_user2):
    return ApiClient(user=customer_user2)


@pytest.fixture
def seller_api_client(seller_user):
    return ApiClient(user=seller_user)
