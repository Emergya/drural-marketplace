...
def test_append_checkout_details_tax_included(
    ...
    unit_price.return_value = quantize_price(TaxedMoney(net=net, gross=gross), "EUR")
        ...
        "lineItems": [
            {
                ...
                "quantity": line.quantity,
                "id": line.variant.sku,
                "taxAmount": price_to_minor_unit((gross - net).amount, "EUR"),
                "taxPercentage": 2300,
                "amountExcludingTax": price_to_minor_unit(net.amount, "EUR"),
                "amountIncludingTax": price_to_minor_unit(gross.amount, "EUR"),
            },
            {
                "amountExcludingTax": "1000",
                "amountIncludingTax": "1000",
