...
def test_process_payment(
    ...
    payment_info.data["stripe_account_id"] = "acct_1234"
    ...
    mocked_payment_intent.assert_called_once_with(
        amount=int(price_to_minor_unit(payment_info.amount, payment_info.currency)),
        currency=payment_info.currency,
        application_fee_amount=0,
        stripe_account=payment_info.data["stripe_account_id"],
