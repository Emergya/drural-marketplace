...
@app.task(compression="zlib")
def send_order_custom_confirmation_email_task(
    recipient_email, payload, config, subject, template
):
    """Send order confirmation email."""
    email_config = EmailConfig(**config)
...
@app.task(compression="zlib")
def send_company_created_email_task(
    recipient_email, payload, config, subject, template
):
    email_config = EmailConfig(**config)
...
@app.task(compression="zlib")
def send_company_add_agent_email_task(
    recipient_email, payload, config, subject, template
):
    email_config = EmailConfig(**config)
...
@app.task(compression="zlib")
def send_company_validation_email_task(
    recipient_email, payload, config, subject, template
):
    email_config = EmailConfig(**config)
...
@app.task(compression="zlib")
def send_fraudulent_product_report_task(
    recipient_email, payload, config, subject, template
):
    email_config = EmailConfig(**config)
...
@app.task(compression="zlib")
def send_product_featured_task(recipient_email, payload, config, subject, template):
    email_config = EmailConfig(**config)
