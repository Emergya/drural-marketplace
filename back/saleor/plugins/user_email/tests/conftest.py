...
@pytest.fixture
def user_email_plugin(settings, channel_EUR):
    def fun(
        host="localhost",
        port="1025",
        username=None,
        ...
        custom_order_confirmation_template=DEFAULT_EMAIL_VALUE,
            ...
            manager.save_plugin_configuration(
                ...
                channel_EUR.slug,
                {
                    ...
                    "configuration": [
                        ...
                        {
                            "name": CUSTOM_ORDER_CONFIRMATION_TEMPLATE_FIELD,
                            "value": custom_order_confirmation_template,
                        },
                        {
