...
def test_event_map():
    assert get_user_event_map() == {
        ...
        NotifyEventType.CUSTOM_ORDER_CONFIRMATION: send_custom_order_confirmation,
        ...
        NotifyEventType.COMPANY_CREATED: send_company_created,
        NotifyEventType.COMPANY_VALIDATION: send_company_validation,
        NotifyEventType.FRAUDULENT_PRODUCT_REPORT: send_fraudulent_product_report,
        NotifyEventType.PRODUCT_FEATURED: send_product_featured,
        NotifyEventType.COMPANY_ADD_AGENT: send_company_add_agent,
    }
