...
def send_custom_order_confirmation_email_task(payload: dict, configuration: dict):
    """Send order confirmation email."""
    configuration = SendgridConfiguration(**configuration)
    send_email(
        configuration=configuration,
        template_id=configuration.custom_order_confirmation_template_id,
        payload=payload,
    )
    order_events.event_custom_order_confirmation_notification(
        order_id=payload["order"]["id"],
        user_id=payload["order"].get("user_id"),
        customer_email=payload["recipient_email"],
    )
...
def send_company_created_email_task(payload: dict, configuration: dict):
    configuration = SendgridConfiguration(**configuration)
    send_email(
        configuration=configuration,
        template_id=configuration.company_created_template_id,
        payload=payload,
    )
...
def send_company_validation_email_task(payload: dict, configuration: dict):
    configuration = SendgridConfiguration(**configuration)
    send_email(
        configuration=configuration,
        template_id=configuration.company_created_template_id,
...
def send_company_add_agent_email_task(payload: dict, configuration: dict):
    configuration = SendgridConfiguration(**configuration)
    send_email(
        configuration=configuration,
        template_id=configuration.company_add_agent_template_id,
        payload=payload,
    )
...
def send_fraudulent_product_report_task(payload: dict, configuration: dict):
    configuration = SendgridConfiguration(**configuration)
    send_email(
        configuration=configuration,
        template_id=configuration.fraudulent_product_report_template_id,
        payload=payload,
    )
...
def send_product_featured_task(payload: dict, configuration: dict):
    configuration = SendgridConfiguration(**configuration)
    send_email(
        configuration=configuration,
        template_id=configuration.product_featured_template_id,
        payload=payload,
    )
