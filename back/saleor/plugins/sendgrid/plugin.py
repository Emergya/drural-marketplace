...
from .tasks import (
    ...
    send_custom_order_confirmation_email_task,
...
EVENT_MAP = {
    ...
    UserNotifyEvent.CUSTOM_ORDER_CONFIRMATION: (
        send_custom_order_confirmation_email_task,
        "custom_order_confirmation_template_id",
    ),
    ...
    UserNotifyEvent.COMPANY_CREATED: (
        send_company_created_email_task,
        "company_pending_template_id",
    ),
    UserNotifyEvent.COMPANY_ADD_AGENT: (
        send_company_created_email_task,
        "company_add_agent_template_id",
    ),
    UserNotifyEvent.COMPANY_VALIDATION: (
        send_company_validation_email_task,
        "company_validation_template_id",
    ),
    UserNotifyEvent.FRAUDULENT_PRODUCT_REPORT: (
        send_fraudulent_product_report_task,
        "fraudulent_product_report_template_id",
    ),
    UserNotifyEvent.PRODUCT_FEATURED: (
        send_product_featured_task,
        "product_validation_template_id",
    ),
}
...
class SendgridEmailPlugin(BasePlugin):
    ...
    DEFAULT_CONFIGURATION = [
        ...
        {"name": "custom_order_confirmation_template_id", "value": None},
        ...
        {"name": "company_created_template_id", "value": None},
        {"name": "company_validation_template_id", "value": None},
        {"name": "company_add_agent_template_id", "value": None},
        {"name": "fraudulent_product_report_template_id", "value": None},
        {"name": "product_featured_template_id", "value": None},
    ...
    CONFIG_STRUCTURE = {
        ...
        "custom_order_confirmation_template_id": {
            "type": ConfigurationTypeField.STRING,
            "help_text": HELP_TEXT_TEMPLATE,
            "label": "Custom order confirmation email template",
        },
        "order_confirmed_template_id": {
            "type": ConfigurationTypeField.STRING,
        ...
        "company_created_template_id": {
            "type": ConfigurationTypeField.STRING,
            "help_text": HELP_TEXT_TEMPLATE,
            "label": "Company created email template",
        },
        "company_add_agent_template_id": {
            "type": ConfigurationTypeField.STRING,
            "help_text": HELP_TEXT_TEMPLATE,
        ...
        "company_validation_template_id": {
            "type": ConfigurationTypeField.STRING,
            "help_text": HELP_TEXT_TEMPLATE,
            "label": "Company validation email template",
        },
        "fraudulent_product_report_template_id": {
            "type": ConfigurationTypeField.STRING,
            "help_text": HELP_TEXT_TEMPLATE,
            "label": "Fraudulent product report",
        },
        "product_featured_template_id": {
            "type": ConfigurationTypeField.STRING,
            "help_text": HELP_TEXT_TEMPLATE,
            "label": "Product featured notification",
        },
        "api_key": {
