...
def test_get_channels_headers(channel_EUR):
    # given
    channel_EUR_slug = channel_EUR.slug

    channel_ids = [channel_EUR.pk]
    ...
    # then
    expected_headers = []
    for channel_slug in [channel_EUR_slug]:
        for field in [
...
def test_get_export_fields_and_headers_info(
    warehouses, product_with_multiple_values_attributes, channel_EUR
):
    # given
