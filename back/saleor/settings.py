...
MK_POSTGRES_USER = os.environ.get("MK_POSTGRES_USER")
MK_POSTGRES_PASS = os.environ.get("MK_POSTGRES_PASS")
MK_POSTGRES_HOST = os.environ.get("MK_POSTGRES_HOST")
MK_POSTGRES_PORT = os.environ.get("MK_POSTGRES_PORT")
MK_POSTGRES_DB = os.environ.get("MK_POSTGRES_DB")
MK_DATABASE_URL = f"postgres://{MK_POSTGRES_USER}:{MK_POSTGRES_PASS}@{MK_POSTGRES_HOST}:{MK_POSTGRES_PORT}/{MK_POSTGRES_DB}"

if not MK_POSTGRES_USER:
    config = RawConfigParser()
    config.read("settings.ini")
    MK_DATABASE_URL = config.get("db", "MK_DATABASE_URL")

DATABASES = {
    "default": dj_database_url.config(
        default=MK_DATABASE_URL,
        conn_max_age=600,
...
TZ_REGION = os.environ.get("TZ_REGION", "UTC")
TIME_ZONE = TZ_REGION
LANGUAGE_CODE = "en"
...
DEFAULT_FROM_EMAIL = os.environ.get("MK_DEFAULT_FROM_EMAIL", EMAIL_HOST_USER)
...
SECRET_KEY = os.environ.get("MK_SECRET_KEY")
...
AUTH_PASSWORD_VALIDATORS = [
    {"NAME": "saleor.account.validators.ContainsOneDigitsValidator"},
    {"NAME": "saleor.account.validators.ContainsOneUppercaseValidator"},
    {"NAME": "saleor.account.validators.ContainsOneLowercaseValidator"},
    {
        "NAME": "saleor.account.validators.ContainsOneSpecialCharactersValidator",
    },
    {
...
EUR_TO_HRK_RATE = os.environ.get("EUR_TO_HRK_RATE", False)
...
# Dev Populate = True -->  Testing Data
# Dev Populate = False --> Only required data, almost empty DB
POPULATE_DEV = get_bool_from_env("POPULATE_DEV", False)
...
MINIO_SERVER_ACCESS_KEY = os.environ.get("MINIO_SERVER_ACCESS_KEY")
MINIO_SERVER_SECRET_KEY = os.environ.get("MINIO_SERVER_SECRET_KEY")
MINIO_MK_MEDIA_CUSTOM_DOMAIN = os.environ.get("MINIO_MK_MEDIA_CUSTOM_DOMAIN")
MINIO_MK_MEDIA_BUCKET_NAME = os.environ.get("MINIO_MK_MEDIA_BUCKET_NAME")
AWS_ACCESS_KEY_ID = MINIO_SERVER_ACCESS_KEY
AWS_SECRET_ACCESS_KEY = MINIO_SERVER_SECRET_KEY
AWS_STORAGE_BUCKET_NAME = MINIO_MK_MEDIA_BUCKET_NAME
AWS_S3_CUSTOM_DOMAIN = MINIO_MK_MEDIA_CUSTOM_DOMAIN
AWS_MEDIA_BUCKET_NAME = MINIO_MK_MEDIA_BUCKET_NAME
...
# STRIPE SETTINGS
# This stripe settings is for dev environment, you can change this
# values in dashboard: configuration > plugins > Stripe
STRIPE_PUBLIC_API_KEY = os.environ.get("STRIPE_PUBLIC_KEY")
STRIPE_SECRET_API_KEY = os.environ.get("STRIPE_SECRET_KEY")
STRIPE_SUPPORTED_CURRENCIES = os.environ.get("STRIPE_SUPPORTED_CURRENCIES", "EUR")
STRIPE_WEBHOOK_ENDPOINT_ID = os.environ.get("STRIPE_WEBHOOK_ID")
STRIPE_WEBHOOK_SECRET_KEY = os.environ.get("STRIPE_WEBHOOK_SECRET_KEY")

# CELERY SETTINGS
CELERY_TIMEZONE = TIME_ZONE
CELERY_BROKER_URL = (
    os.environ.get("MK_CELERY_BROKER_URL", os.environ.get("CLOUDAMQP_URL")) or ""
)
...
# Reservation wait time to complete checkout
RESERVATION_GRACE_TIME = os.environ.get("RESERVATION_GRACE_TIME", 15)
...
CACHES["default"]["TIMEOUT"] = parse(os.environ.get("CACHE_TIMEOUT", "300"))
...
CHATWOOT_URI = os.environ.get("CHATWOOT_URI")
...
# Feature flags
FEATURE_WAREHOUSES = get_bool_from_env("FEATURE_WAREHOUSES", False)
FEATURE_SHIPPING = get_bool_from_env("FEATURE_SHIPPING", False)

FEATURE_VOUCHERS = get_bool_from_env("FEATURE_VOUCHERS", False)
FEATURE_SALES = get_bool_from_env("FEATURE_SALES", False)
