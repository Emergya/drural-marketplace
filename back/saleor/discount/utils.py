...
if TYPE_CHECKING:
    ...
    from ..product.models import Collection, Product, Category
...
def get_product_discount_on_sale(
    ...
    is_product_on_sale = (
        ...
        or product_categories.intersection(discount.category_ids)
